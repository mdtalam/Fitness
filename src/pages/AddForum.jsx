...
import { Loader2, ArrowLeft, FileText, Image as ImageIcon, Sparkles, Send, Camera } from 'lucide-react';
...
const AddForum = () => {
    ...
    const addForumMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            navigate('/dashboard/manage-forums');
        },
        onError: (error) => {
            ...
            >
                ...
                <div className="mb-12">
                    <SectionHeader
                        ...
                        subtitle="Create Forum Post"
                        description="Inspire the community with your knowledge, tips, and fitness journeys."
                    />
                </div>
                            ...
                            <Card className="rounded-[2.5rem] border-none shadow-2xl shadow-primary/5 overflow-hidden">
                                <CardHeader className="bg-primary/5 p-8 border-b border-primary/10">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription>Tell your story or share your advice.</CardDescription>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-8 space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            id="title"
                                            placeholder="e.g. 5 Myths About Cardio You Need to Stop Believing"
                            ...
                            <Card className="rounded-[2.5rem] border-none shadow-2xl shadow-primary/5 overflow-hidden">
                                ...
                                <CardContent className="p-8 space-y-6">
                                    ...
                                    <Button
                                        ...
                                        disabled={addForumMutation.isPending || uploading}
                                    >
                                        {addForumMutation.isPending ? (
