...
const AddSlot = () => {
    ...
    // 1. Fetch Trainer Application for Read-only data and days
    ...
    // 2. Fetch All Classes for selection
    ...
    const handleSubmit = (e) => {
        ...
        console.log('Publishing Slot Data:', submissionData);
        createMutation.mutate(submissionData);
    };

    if (isAppLoading || isClassesLoading) {
        return (
            <DashboardLayout>
    ...
    return (
        <DashboardLayout>
            <SectionHeader
                ...
                description="Create a new training session slot for your students."
            />
                ...
                <Card className="rounded-[2.5rem] border-none shadow-2xl shadow-primary/5 bg-muted/30 overflow-hidden relative">
                    ...
                    <CardContent className="p-8 space-y-6">
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col gap-1">
                                <Label className="text-[10px] font-black uppercase tracking-widest text-primary/60">Bio</Label>
                                <p className="text-xs font-medium text-muted-foreground leading-relaxed italic line-clamp-3">"{appData?.bio}"</p>
                            </div>
                            <div className="flex flex-col gap-1">
                            ...
                            <CardContent className="p-10 space-y-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-3 md:col-span-2">
                                        ...
                                        />
                                        <p className="text-[10px] font-bold text-muted-foreground ml-1">Select from your pre-approved availability list.</p>
                                    </div>
                                ...
                                <Button
                                    ...
                                    className="w-full h-16 rounded-2xl font-black uppercase tracking-widest shadow-2xl shadow-primary/30 text-lg transition-all hover:scale-[1.02] active:scale-[0.98] mt-4"
                                >
                                    {createMutation.isPending ? (
                                        <><Loader2 className="mr-2 h-6 w-6 animate-spin" /> Publishing...</>
                                    ) : (
                                        <><CheckCircle2 className="mr-2 h-6 w-6" /> Add Slot to Schedule</>
                                    )}
                                </Button>
                            </CardContent>
                        </form>
